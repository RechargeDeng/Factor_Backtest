...
class LSTM_stacked_model(nn.Module):
    def __init__(self,num_layers_s, input_size_s, hidden_size_s_1,hidden_size_s_2,hidden_size_s_3,device):
        super().__init__()        
...
class LSTM_MLP_model(nn.Module):
    def __init__(self,num_layers, input_size, hidden_size, fc_size,device):
        super().__init__()
        self.input_size = input_size
        self.hidden_size = hidden_size
        self.lstm = nn.LSTM(num_layers=num_layers,
